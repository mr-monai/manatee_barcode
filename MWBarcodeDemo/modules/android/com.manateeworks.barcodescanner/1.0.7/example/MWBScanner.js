/**
  ...
  */
  ...
  var RECT_FULL_1D = {'left': 5, 'top': 5, 'width': 90, 'height': 90};
  var RECT_FULL_2D = {'left': 20, 'top': 5, 'width': 60, 'height': 90};
  var RECT_PORTRAIT_1D = {'left': 20, 'top': 5, 'width': 60, 'height': 90};
  var RECT_PORTRAIT_2D = {'left': 20, 'top': 5, 'width': 60, 'height': 90};
  var RECT_LANDSCAPE_1D = {'left': 5, 'top': 20, 'width': 90, 'height':60};
  var RECT_LANDSCAPE_2D = {'left': 20, 'top': 5, 'width': 60, 'height': 90};
  var RECT_DOTCODE = {'left': 30, 'top': 20, 'width': 40, 'height': 60};
  ...
  var startScanning = function()
  {
     	...
     	//adjust user interface
   		...
   		BarcodeScanner.MWBsetCloseCameraOnDetection(true);
   		...
   		scanner.startScanning({
		    ...
		    success:function(result) {
		      ...
		      BarcodeScanner.MWBcloseScanner();
		        ...
		        var alert = Titanium.UI.createAlertDialog({ title: result.type + (result.isGS1?" (GS1)":""), message: result.code, buttonNames: ['OK', 'Cancel'], cancel: 1 });
